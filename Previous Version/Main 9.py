...
from FFT import FFT
from threshold_v1 import get_threshold
        ...
        if current_time > last_time + 1:
            ...
            if serialPort.in_waiting > 0:
                ...
                if data == "Sending Stopped":
                    ...
                    print(FFT(raw_y_list[-750:],50))
                    print(FFT(processed_y_list[-750:],50))
                    print(get_threshold(processed_y_list[-750:]))
                    print(ran)
                ...
                if heart_rate_value > high_warning:
                    ...
                    ##################### Tranmission Warning #####################
            print(tranmission_stable_sequence)
            print(tranmission_stable_time)
