...
def Log(Info,log_list):
    ...
    log_window.update(value = log_list)
    #print(log_list)
    # update the window
        ...
        if current_time > last_time + 1:
            ...
            if tranmission_stable_sequence and tranmission_stable_time:
                ...
                if Tranmission_unstable_not_logged:
                    Log("Tranmission Unstable",log_list)
            ...
            if tranmission_stop:
                ...
                if Tranmission_stop_by_user_not_logged:
                    Log("Tranmission Stopped by User",log_list)
