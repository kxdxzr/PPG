    ...
    while True:
        ...
        if current_time > last_time + 1:
            if serialPort.in_waiting > 0:
                ...
                BPF_processed_data = BPF.butter_filter(rescurrent_pulse)
                #processed_y_list = BPF.butter_filter(raw_y_list).tolist()
                processed_y_list = processed_y_list + BPF_processed_data.tolist()
